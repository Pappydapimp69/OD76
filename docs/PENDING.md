...
- Glow Pond → Glow Echo: Pip lights lily pads in a pattern; the player walks onto the pads in the same order. The pattern grows by one each round (3, 4, 5).
