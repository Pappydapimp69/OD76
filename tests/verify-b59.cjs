...
if (files.length !== 123 || files.at(-1) !== 'b21-123.js' || files[98] !== 'b21-99.js') throw Error('B117 module order');
...
vm.runInContext('pipSetupOnB117u=false', dom.getInternalVMContext());
